...
echo -e " [ ... ] 최신 한국투자증권(KIS) 종목 마스터 데이터 동기화 중..."
curl -s -X POST http://localhost/api/v1/stocks/sync >/dev/null 2>&1
echo -e " ${GREEN}[  OK ] 종목 데이터 동기화 완료.${NC}"
echo ""

echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW} [ IMPORTANT : 최초 실행 시 필수 설정 ]${NC}"
echo -e "  브라우저에 앱이 열리면 자동으로 [설정] 팝업이 나타납니다."
...
echo -e "    K-STOCK LIVE는 Docker에서 백그라운드로 계속 실행됩니다."
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
